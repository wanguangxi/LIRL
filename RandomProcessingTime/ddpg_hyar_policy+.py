...
def main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder):
...
if __name__ == '__main__':
    ...
    episodes = 1500
    score_records = []
    encoder="conditional_autoencoder_5_5.pth"
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job5_score_cae_records_0.2_0.8_co_.npy',score_records)


    print("start 0.8-0.2-5")
    num_of_jobs = 5
    num_of_robots = 5
    alpha = 0.8
    beta = 0.2
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job5_score_cae_records_0.8_0.2_co_.npy',score_records)


    print("start 0.4-0.6-5")
    num_of_jobs = 5
    num_of_robots = 5
    alpha = 0.4
    beta = 0.6
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job5_score_cae_records_0.4_0.6_co_.npy',score_records)



    print("start 0.6-0.4-5")
    num_of_jobs = 5
    num_of_robots = 5
    alpha = 0.6
    beta = 0.4
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job5_score_cae_records_0.6_0.4_co_.npy',score_records)


    print("start 0.5-0.5-5")
    num_of_jobs = 5
    num_of_robots = 5
    alpha = 0.5
    beta = 0.5
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job5_score_cae_records_0.5_0.5_co_.npy',score_records)


##############################################################################


    print("start 0.2-0.8-10")
    num_of_jobs = 10
    num_of_robots = 5
    alpha = 0.2
    beta = 0.8
    episodes = 1500
    score_records = []
    encoder="conditional_autoencoder_10_5.pth"
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job10_score_cae_records_0.2_0.8_co_.npy',score_records)


    print("start 0.8-0.2-10")
    num_of_jobs = 10
    num_of_robots = 5
    alpha = 0.8
    beta = 0.2
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job10_score_cae_records_0.8_0.2_co_.npy',score_records)




    print("start 0.4-0.6-10")
    num_of_jobs = 10
    num_of_robots = 5
    alpha = 0.4
    beta = 0.6
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job10_score_cae_records_0.4_0.6_co_.npy',score_records)



    print("start 0.6-0.4-10")
    num_of_jobs = 10
    num_of_robots = 5
    alpha = 0.6
    beta = 0.4
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job10_score_cae_records_0.6_0.4_co_.npy',score_records)


    print("start 0.5-0.5-10")
    num_of_jobs = 10
    num_of_robots = 5
    alpha = 0.5
    beta = 0.5
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job10_score_cae_records_0.5_0.5_co_.npy',score_records)

###########################################################################################

    print("start 0.2-0.8-20")
    num_of_jobs = 20
    num_of_robots = 5
    alpha = 0.2
    beta = 0.8
    episodes = 1500
    score_records = []
    encoder="conditional_autoencoder_20_5.pth"
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job20_score_cae_records_0.2_0.8_co_.npy',score_records)


    print("start 0.8-0.2-20")
    num_of_jobs = 20
    num_of_robots = 5
    alpha = 0.8
    beta = 0.2
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job20_score_cae_records_0.8_0.2_co_.npy',score_records)




    print("start 0.4-0.6-20")
    num_of_jobs = 20
    num_of_robots = 5
    alpha = 0.4
    beta = 0.6
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job20_score_cae_records_0.4_0.6_co_.npy',score_records)



    print("start 0.6-0.4-20")
    num_of_jobs = 20
    num_of_robots = 5
    alpha = 0.6
    beta = 0.4
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job20_score_cae_records_0.6_0.4_co_.npy',score_records)


    print("start 0.5-0.5-20")
    num_of_jobs = 20
    num_of_robots = 5
    alpha = 0.5
    beta = 0.5
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job20_score_cae_records_0.5_0.5_co_.npy',score_records)



###########################################################################################

    print("start 0.2-0.8-50")
    num_of_jobs = 50
    num_of_robots = 5
    alpha = 0.2
    beta = 0.8
    episodes = 1500
    score_records = []
    encoder="conditional_autoencoder_50_5.pth"
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job50_score_cae_records_0.2_0.8_co_.npy',score_records)


    print("start 0.8-0.2-50")
    num_of_jobs = 50
    num_of_robots = 5
    alpha = 0.8
    beta = 0.2
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job50_score_cae_records_0.8_0.2_co_.npy',score_records)




    print("start 0.4-0.6-50")
    num_of_jobs = 50
    num_of_robots = 5
    alpha = 0.4
    beta = 0.6
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job50_score_cae_records_0.4_0.6_co_.npy',score_records)



    print("start 0.6-0.4-50")
    num_of_jobs = 50
    num_of_robots = 5
    alpha = 0.6
    beta = 0.4
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job50_score_cae_records_0.6_0.4_co_.npy',score_records)


    print("start 0.5-0.5-50")
    num_of_jobs = 50
    num_of_robots = 5
    alpha = 0.5
    beta = 0.5
    ...
    for i in range(10):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,encoder))
    score_records=np.array(score_records)
    np.save('job50_score_cae_records_0.5_0.5_co_.npy',score_records)    
