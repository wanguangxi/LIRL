...
def main(num_of_jobs, num_of_robots,alpha,beta,episodes):
    ...
    return score_record,action_restore
...
if __name__ == '__main__':
    ...
    action_restores = []
    for i in range(1):
        score_record,action_restore = main(num_of_jobs, num_of_robots,alpha,beta,episodes)
        score_records.append(score_record)
        action_restores.append(action_restore)
    score_records=np.array(score_records)
    action_restores = np.array(action_restore)
    np.save('job5_score_records_0.2_0.8_co.npy',score_records)
    np.save('job5_action_records_0.2_0.8_co_2000.npy',action_restores)
    print("training done!")
