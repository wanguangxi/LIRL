...
if __name__ == '__main__':
    ...
    np.save('job10_score_records_0.2_0.8_co_breakdown.npy',score_records)

    print("job 10 10 0.4-0.6")
    num_of_jobs =10
    num_of_robots = 10
    alpha = 0.4
    beta = 0.6
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job10_score_records_0.4_0.6_co_breakdown.npy',score_records)



    print("job 10 10 0.5-0.5")
    num_of_jobs =10
    num_of_robots = 10
    alpha = 0.5
    beta = 0.5
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job10_score_records_0.5_0.5_co_breakdown.npy',score_records)

    print("job 10 10 0.6-0.4")
    num_of_jobs =10
    num_of_robots = 10
    alpha = 0.6
    beta = 0.4
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job10_score_records_0.6_0.4_co_breakdown.npy',score_records)

    print("job 10 10 0.8-0.2")
    num_of_jobs =10
    num_of_robots = 10
    alpha = 0.8
    beta = 0.2
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job10_score_records_0.8_0.2_co_breakdown.npy',score_records)



    #################################################################
    print("job 20 10 0.2-0.8")
    num_of_jobs =20
    num_of_robots = 10
    alpha = 0.2
    beta = 0.8
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job20_score_records_0.2_0.8_co_breakdown.npy',score_records)

    print("job 20 10 0.4-0.6")
    num_of_jobs =20
    num_of_robots = 10
    alpha = 0.4
    beta = 0.6
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job20_score_records_0.4_0.6_co_breakdown.npy',score_records)



    print("job 20 10 0.5-0.5")
    num_of_jobs =20
    num_of_robots = 10
    alpha = 0.5
    beta = 0.5
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job20_score_records_0.5_0.5_co_breakdown.npy',score_records)

    print("job 20 10 0.6-0.4")
    num_of_jobs =20
    num_of_robots = 10
    alpha = 0.6
    beta = 0.4
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job20_score_records_0.6_0.4_co_breakdown.npy',score_records)


    print("job 20 10 0.8-0.2")
    num_of_jobs =20
    num_of_robots = 10
    alpha = 0.8
    beta = 0.2
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job20_score_records_0.8_0.2_co_breakdown.npy',score_records)
    
    #################################################
    print("job 50 10 0.2-0.8")
    num_of_jobs =50
    num_of_robots = 10
    alpha = 0.2
    beta = 0.8
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job50_score_records_0.2_0.8_co_breakdown.npy',score_records)

    print("job 50 10 0.4-0.6")
    num_of_jobs =50
    num_of_robots = 10
    alpha = 0.4
    beta = 0.6
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job50_score_records_0.4_0.6_co_breakdown.npy',score_records)



    print("job 50 10 0.5-0.5")
    num_of_jobs =50
    num_of_robots = 10
    alpha = 0.5
    beta = 0.5
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job50_score_records_0.5_0.5_co_breakdown.npy',score_records)

    print("job 50 10 0.6-0.4")
    num_of_jobs =50
    num_of_robots = 10
    alpha = 0.6
    beta = 0.4
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job50_score_records_0.6_0.4_co_breakdown.npy',score_records)


    print("job 50 10 0.8-0.2")
    num_of_jobs =50
    num_of_robots = 10
    alpha = 0.8
    beta = 0.2
    ...
    for i in range(50):
        score_records.append(main(num_of_jobs, num_of_robots,alpha,beta,episodes,breakdown_times,breakdown_rate))
    score_records=np.array(score_records)
    np.save('job50_score_records_0.8_0.2_co_breakdown.npy',score_records)